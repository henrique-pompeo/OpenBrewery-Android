...
import com.henrique.openbrewery.brewerydetail.domain.mappers.BreweryDetailMapper
...
class BreweryDetailUseCaseImplTest {
    private val breweryDetailUseCase: BreweryDetailUseCase = getBreweryDetailUseCase()
